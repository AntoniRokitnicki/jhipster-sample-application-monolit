...
import feed.monolit.config.KafkaSseConsumer;
import feed.monolit.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/jhipster-sample-application-monolit-kafka")
public class JhipsterSampleApplicationMonolitKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationMonolitKafkaResource.class);
    ...
    public JhipsterSampleApplicationMonolitKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
